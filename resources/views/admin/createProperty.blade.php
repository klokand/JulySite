...
<div class="form-group">
	...
	{!!Form::select('property_type',['House'=>'House','Unit'=>'Unit','Land'=>'Land','Apartment'=>'Apartment','Town House'=>'Town House','Home Land Package'=>'Home Land Package','Display Home'=>'Display Home','Off-the-plan'=>'Off-the-plan','Completed Units'=>'Completed Units'],['class'=>'form-control'])!!}
</div>
<div class="form-group">
